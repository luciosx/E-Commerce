...
ActiveRecord::Schema.define(version: 2020_12_01_114038) do
  ...
  create_table "product_categoties", force: :cascade do |t|
    t.bigint "product_id", null: false
    t.bigint "category_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id"], name: "index_product_categoties_on_category_id"
    t.index ["product_id"], name: "index_product_categoties_on_product_id"
  end
  ...
  add_foreign_key "product_categoties", "categories"
  add_foreign_key "product_categoties", "products"
end
